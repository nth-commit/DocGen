...
{
    public class TemplateStep : ITemplateComponent
    {
        ...
        public IEnumerable<TemplateStepInput> Inputs { get; set; } = Enumerable.Empty<TemplateStepInput>(); // Can be empty if a parent step.
